...
const Footer = () => {
    return (
        <>
            <footer className="footer w-full min-h-screen flex items-center justify-center bg-zinc-900">
                <div className="container md:w-2/3 w-full px-4 text-white flex flex-col">
                    ...
                    <div className="flex flex-col">
                        <div className="flex mt-20 mb-10 flex-row justify-between">
                            <div className="">
                                <h3 className='text-3xl font-semibold'>LUSTRE</h3>
                            </div>
                        ...
                        <p className="w-full text-center my-12 text-gray-600">Copyright © 2024 ak Creative</p>
                    </div>
                </div>
            </footer>
        </>
